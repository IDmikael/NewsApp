...
class AllNewsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        pbAllNews.visibility = View.VISIBLE
    ...
    private fun initializeRecycler() {
        ...
        rvAllNews.layoutManager = layoutManager
        rvAllNews.itemAnimator = DefaultItemAnimator()

        rvAllNews.addOnScrollListener(InfiniteScrollListener({ loadData() }, layoutManager))
    ...
    private fun loadData() {
        ...
        viewModel.newsResult().observe(this,
                Observer<NewsResponse> {
                    if (it != null) {
                        ...
                        rvAllNews.adapter = adapter
                        rvAllNews.scrollToPosition(position - 20)
                    }
                })
        ...
        viewModel.newsLoader().observe(this, Observer<Boolean> {
            if (it == false) pbAllNews.visibility = View.GONE
        })
    }
}
